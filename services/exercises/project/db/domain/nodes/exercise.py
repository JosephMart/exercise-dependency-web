...
class Exercise(Entity):
    ...
    def __init__(self, id: Optional[int, None], question: str, solution: str, created_at=datetime.now(), updated_at=datetime.now()):
    ...
    def deserialize(**kwargs) -> Exercise:
        ...
        return Exercise(kwargs['id'], kwargs['question'], kwargs['solution'], kwargs['created_at'], kwargs['updated_at'])
