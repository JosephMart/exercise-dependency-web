...
class Topic(Entity):
    ...
    def __init__(self, id: Optional[int, None], name: str, created_at=datetime.now(), updated_at=datetime.now()):
    ...
    def deserialize(**kwargs) -> Topic:
        ...
        return Topic(kwargs['id'], kwargs['name'], kwargs['created_at'], kwargs['updated_at'])
